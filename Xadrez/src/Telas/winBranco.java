...
public class winBranco {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					winBranco window = new winBranco();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 653, 448);
       ...
       ImageIcon img = new ImageIcon(this.getClass().getResource("/brancoWin2.png"));
		...
		fundotela.setBounds(0, 0, 644, 416);
